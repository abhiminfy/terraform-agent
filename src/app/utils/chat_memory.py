...
class ChatMemory:
    ...
    def save_message(self, chat_id: str, role: str, message: str, metadata: Dict[str, Any] = None) -> bool:
    ...
    def update_chat_metadata(self, chat_id: str, title: str = None, archived: bool = None, settings: Dict[str, Any] = None) -> bool:
    ...
    def get_chat_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            most_active = max(all_chats, key=lambda x: x.get('message_count', 0)) if all_chats else None
    ...
    def cleanup_old_chats(self, days_old: int = 30, archive_instead: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Cleanup completed: {processed_count} chats processed, {archived_count} archived, {deleted_count} deleted")
